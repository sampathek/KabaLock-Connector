 ...
 *         &lt;element name="RoomList" type="{http://tempuri.org}ArrayOfString" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "ChangeGuestAccess")
public class ChangeGuestAccess {
    ...
    protected ArrayOfString roomList;
     ...
     *     
     */
    public ArrayOfString getRoomList() {
        return roomList;
    }
     ...
     *     
     */
    public void setRoomList(ArrayOfString value) {
        this.roomList = value;
    }
